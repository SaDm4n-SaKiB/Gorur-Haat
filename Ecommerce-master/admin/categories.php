        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="cat_title" class="form-control" placeholder="Enter Class Name">
		        	</div>
        		</div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                ...
                <input type="text" name="e_cat_title" class="form-control" placeholder="Enter Class Name">
              </div>
            </div>
